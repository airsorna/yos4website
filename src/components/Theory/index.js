    ...
    <TheoryContainer id='theory'>
        ...
        <TheoryWrapper>
            <TheoryH2>Blog_______Posts.</TheoryH2>
              ...
              <TheoryP>For this week, I looked for inspiration for my internet art. Here's what I’ve found:</TheoryP>
...
production, whether thats a painting, a picture, or music. We can acknowledge that 
fact. Fast-forwarding to the present day, we dont define art by its physical presence 
...
reproducibility in mind.
              ...
              <TheoryP>The website I find to interesting, and I wish to mirror to some effect is by SNR4 a creative developer from Mexico. His/her website titled SNR4 Portfolio is amazing and looks incredibly.</TheoryP>
              <TheoryH2>Conceptual</TheoryH2>
              <TheoryP>Beginning the analysis from a conceptual level, the website was intended to
showcase other websites and work hes involved with. A title, description, and link 
are given for each website, and users can click on the link to visit the website. This is 
unlike anything Ive seen. Usually, with portfolio pages, web designers tend to write 
...
participate and experience life online." (Park, 2007:4). SNR4s concept of having the 
...
<TheoryP>Artsy. (2023). Net Art. [online]. Available at:  [Accessed 28 April 2023]</TheoryP>
...
<TheoryP>SNR4. (2023). Snr4 Portfolio. [online]. Available at:  [Accessed 
